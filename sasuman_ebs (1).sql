...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2025 at 04:23 PM
...
(8, 'admin', 'admin', 'North Korea', 'admin', 'admin@gmail.com', '90001', 'Admin', 'JAvlGPq9JyTdtvBO6x2llnRI1+gxwIyPqCKAn3THIKk=', 'Active', ''),
(9, 'user', 'user', 'North Korea', 'user', 'user@gmail.com', '90002', 'User', '14XWNRGmRaJIdaEJ4O8dplYN2U0Um2c0lJqWVWyzRJ8=', 'Active', 'src/images/logor.png'),
...
--
ALTER TABLE `logs`
  MODIFY `logID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=148;
